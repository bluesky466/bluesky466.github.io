...
const promisifyAccess = (0, util_1.promisify)(graceful_fs_1.default.access);
const promisifyMkdir = (0, util_1.promisify)(graceful_fs_1.default.mkdir);
const promisifyReaddir = (0, util_1.promisify)(graceful_fs_1.default.readdir);
const promisifyReadFile = (0, util_1.promisify)(graceful_fs_1.default.readFile);
const promisifyWriteFile = (0, util_1.promisify)(graceful_fs_1.default.writeFile);
const promisifyCopyFile = (0, util_1.promisify)(graceful_fs_1.default.copyFile);
const promisifyAppendFile = (0, util_1.promisify)(graceful_fs_1.default.appendFile);
const promisifyUnlink = (0, util_1.promisify)(graceful_fs_1.default.unlink);
const promisifyRmdir = (0, util_1.promisify)(graceful_fs_1.default.rmdir);
const rEOL = /\r\n/g;
...
function mkdirs(path) {
    if (!path)
        throw new TypeError('path is required!');
    return bluebird_1.default.resolve(promisifyMkdir(path, { recursive: true }));
}
...
function checkParent(path) {
    return bluebird_1.default.resolve(promisifyMkdir((0, path_1.dirname)(path), { recursive: true }));
}
...
function _readAndFilterDir(path_2) {
    return __awaiter(this, arguments, void 0, function* (path, options = {}) {
        ...
        return (yield promisifyReaddir(path, Object.assign(Object.assign({}, options), { withFileTypes: true })))
...
function _readFile(path_2) {
    return __awaiter(this, arguments, void 0, function* (path, options = {}) {
        ...
        const content = yield promisifyReadFile(path, options);
        ...
        yield bluebird_1.default.map(entries, (item) => {
            ...
            if (item.isDirectory()) {
                return _emptyDir(fullPath, currentPath, options).then((files) => __awaiter(this, void 0, void 0, function* () {
                    results.push(...files);
                    if (!(yield promisifyReaddir(fullPath)).length) {
...
function _ensurePath(path) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!(yield exists(path)))
            return path;
        const files = yield promisifyReaddir((0, path_1.dirname)(path));
