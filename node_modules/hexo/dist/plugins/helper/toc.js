...
function tocHelper(str, options = {}) {
    ...
    const flat = getAndTruncateTocObj(str, { min_depth: options.min_depth, max_depth: options.max_depth }, options.max_items);
    if (!flat.length)
        return '';
    // Prepare class names
...
function getAndTruncateTocObj(str, { min_depth, max_depth }, max_items) {
    let data = (0, hexo_util_1.tocObj)(str, { min_depth, max_depth });
