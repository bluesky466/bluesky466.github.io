...
function processAsset(ctx, file) {
    ...
    const relativeAssetDirPath = id.slice(0, id.lastIndexOf(path_1.posix.sep));
    // Convert relative path to OS-specific absolute path with trailing separator
    const absoluteAssetDirPath = (0, path_1.join)(ctx.base_dir, relativeAssetDirPath) + path_1.sep;
    /* NOTE:
